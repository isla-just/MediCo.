...
<html lang="eng-US">
    ...
    <body>
        ...
        <form action="login.php" enctype="multipart/form-data" method="post">
            ...
            <input class="login-input" name="email" required>
        ...
        <div class="popup">
            <div class="sure">
                <a href="../pages/login.php"><div class="cancel"><img src="../assets/close.png" style="width:20px; float:right"></img></div></a>

            <h3 style="margin-top:150px; color:#FF6174">Your account has been suspended</h3>
            <p style="margin-top:15px; color:#FF6174">Please contact admin for support</p>
