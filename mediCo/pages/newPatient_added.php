...
<html lang="eng-US">
    ...
    <body>
            ...
            <div class="main-card">
                <div class="section1">
                    <div class="slider-container">
                        <div class="slider" style="margin-left:794px">New Patient profile</div>
                        <a href=<?php echo "../pages/newDoc.php?id=" . $send_id . ""?>><p style="text-align: left; margin-left: 15px; margin-top:-30px;">New Doctor profile</p></a>
                    </div>
                    ...
                    <form enctype="multipart/form-data" action= <?php echo "newPatient.php?id=" . $send_id2 . ""?> method="post">
                        ...
                        <div class='Half2'>
                            ...
                            <input class="newDoc" name="patientID" required>
                            <input class="newDoc"style="margin-left: 5.5%;" name="medicalAid" required>

                            <div class="input-labels2">Add profile picture</div>  

                            <div class="changeBtn2">
                            <input type="file" class="profileImage"  name="profile" required>
                            </div>
                            ...
                            <button class="newDocSubmit" type="submit" style="margin-top:20px" name="add_patient">Add Patient</button>
        ...
        <div class="popup">
            <div class="sure">
                <a href="../pages/newPatient.php?id=<?php echo $send_id2?> "><div class="cancel"><img src="../assets/close.png" style="width:20px; float:right"></img></div></a>

            <h3><?php echo $firstname?> has been added to our database</h3>
            <p style="margin-top:15px"><strong><?php echo $medicalAid?><br></strong><?php echo $firstname. " ".  $surname?></p>
            <a href="https://mail.google.com/mail/u/0/#inbox?compose=new"> <div class="sendConfirmation" style="margin-top:180px;">Notify <?php echo $firstname . " " . $surname?></div></a>
            </div>
        </div>
    </body>
</html>