...
//incrementing availability
    $available_query="SELECT * FROM Doctors WHERE id='$user_id'";
    $available_result = mysqli_query($db, $available_query);
    $available= mysqli_fetch_assoc($available_result);

$scale=$available['availability'];
    ...
    <body>
        <div class='container-fluid'>
            ...
            <div class="main-card">
                <div class="section1">
                    ...
                    <form enctype="multipart/form-data" action= <?php echo "newDoc.php?id=" . $send_id . ""?> method="post">
                        ...
                        <div class="input-labels2">First name</div>  
                         ...
                         <input class="newDoc" type="email" name="email" required>
                         <input class="newDoc" style="margin-left: 5.5%;" type="tel" pattern=".{10,}" title="A phone number is at least 10 characters" name="number" required>


                         <div class="input-labels2">Doctor ID</div>  
                         <div class="input-labels2" style="margin-left: 10%;">Gender</div>
                         <input class="newDoc" pattern=".{10,}" title="A doctor ID is at least 10 characters" name="doctorID" required>
                ...
                <input  id="custom-file-input" type="file" name="profile">
                ...
                <div class="section2">
                    ...
                    <input class="newBooking" value="<?php echo $email1?>" type="email" name="email" required>
                    <input class="newBooking" value="<?php echo $number?>" style="margin-left: 4%;" name="number" type="tel" pattern=".{10,}" title="A phone number is at least 10 characters" required>


                    <div class="input-labels">DoctorID</div>   <div class="input-labels" style="margin-left: 4%;">Specialisation</div>
                    <input class="newBooking" value="<?php echo $doctorID?>"  name="doctorID" pattern=".{10,}" title="A doctor ID is at least 10 characters"required>
                    ...
                    <div class="errorBlock3">
                        ...
                        <div class="scale">
                            ...
                            <div class="progress" style="width:<?php echo $scale?>0%"></div>
                        </div>
