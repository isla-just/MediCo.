        ...
        <div class='container-fluid'>
            ...
            <div class="main-card">
                ...
                <div class="section2">
                    ...
                    <input class="newBooking" value="<?php echo $email2?>"  type="email" name="email" required>
                    <input class="newBooking" value="<?php echo $number?>" type="tel" style="margin-left: 4%;"  name="number" required>
                    ...
                    <input class="newBooking" id="custom-file-input" type="file" style="margin-left: 4%; margin-bottom:10px; float:left;" name="profileImage">
