    ...
    <body>
     ...
     <?php endif ?>
        ...
        <div class="popup">
            ...
            <p style="margin-top:15px"><?php echo $dateAndTime?></p>
            <a href="../server/delete_appointment.php?id=<?php echo $appointment_id?>"> <div class="confirmDelete">Delete this appointment</div></a>
            <p>If so, please notify <?php echo $doctor?> and <?php echo $patient?> about the cancellation</p>
            </div>
        </div>
        <script>
