...
<html lang="eng-US">
    ...
    <body>
        <div class='container-fluid'>
            ...
            <div class="main-card">
                ...
                <?php endif ?>
                    ...
                    <input class="newBooking" value="<?php echo $rank2?>"  name="rank" required style="float:left;">
        ...
        <div class="popup">
            <div class="sure">
                <a href="../pages/profile.php?id=<?php echo $user_id?> "><div class="cancel"><img src="../assets/close.png" style="width:20px; float:right"></img></div></a>

            <h3><?php echo $firstName?> has been unbanned</h3>
            <p style="margin-top:15px"><?php echo $rank2?></p>

            <a href="https://mail.google.com/mail/u/0/#inbox?compose=new"> <div class="sendConfirmation" style="margin-top:250px">Notify <?php echo $firstName?></div></a>
