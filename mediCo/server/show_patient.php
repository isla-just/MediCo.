    ...
    if($show_result-> num_rows > 0 ){
        ...
        while($row = $show_result-> fetch_assoc()){
            ...
            if($rank=="head receptionist"){
                ...
                <a href='../pages/newPatient.php?id=". $row['id'] . "'><div class='appointment' value='". $row['id'] . "'>
                ...
                <div class='labels2' style='margin-left:30px'>" . $row['medicalAid'] . "</div>
                <div class='labels3' style='margin-left:34px'>" . $row['patientID'] . "</div>
                <div class='labels4'>" . $row['gender'] . "</div>
                <div class='labels5'style='margin-left:50px'>" . $row['number'] . "</div>
              
            </div></a>
            <a href='../pages/newPatient_delete.php?id=". $row['id'] . "'><div class='delete'><img src='../assets/delete.svg' style='width:22px; float:left;'></img></div></a>
            </div>";
                    ...
                    echo "<div class='appointment-row' style='width:100%;'>
                    <a href='../pages/newPatient.php?id=". $row['id'] . "'><div class='appointment' style='width:100%;' value='". $row['id'] . "'>
                    <div class='profile-pic'><img src='../profiles/". $row['profile'] . "'style='height:40px; width:40px; border-radius:6px;'></img></div>
                    <div class='labels1'>" . $row['firstname'] ." " . $row['surname'] . "</div>
                    <div class='labels2'>" . $row['medicalAid'] . "</div>
                    <div class='labels3'>" . $row['patientID'] . "</div>
                    <div class='labels4'>" . $row['gender'] . "</div>
                    <div class='labels5'>" . $row['number'] . "</div>
